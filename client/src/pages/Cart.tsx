...
const INITIAL_CART: CartItem[] = [
    {
        ...
        name: 'The Celeste Solitaire Brilliant Diamond Ring',
        category: 'Rings',
    ...
    },
    {
        ...
        name: 'Aurelia Hand-Woven 18k Chain Link Necklace',
        category: 'Necklaces',
    ...
    //     name: 'La Mer Baroque Luminous Pearl Drop Earrings',
    //     category: 'Earrings',
    //     image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=600&q=80',
    //     quantity: 1,
    //     price: 3200,
    //     inStock: false, // Simulates out of stock visual treatment
    // }
];
...
export default function CartPage() {
    ...
    // Simulation loading delay for initial visual frame rendering stability
    useEffect(() => {
    ...
    const shippingFee = subtotal > 15000 || subtotal === 0 ? 0 : 150;
    const estimatedTotal = subtotal - appliedDiscount + shippingFee;

    // Quantity Control Core Loop
    const updateQuantity = (id: string, delta: number) => {
        setCart((prev) =>
            prev.map((item) => {
                if (item.id !== id) return item;
                const targetQty = item.quantity + delta;
                return targetQty >= 1 ? { ...item, quantity: targetQty } : item;
            })
        );
    };
    ...
    // Static Promo Code Evaluation Simulator
                    ...
                    <AnimatePresence mode="wait">
                        {isPageLoading ? (
                            ...
                            >
                                ...
                                <div className="lg:col-span-4 lg:sticky lg:top-8 space-y-6">
                                    <div className="bg-[var(--color-bg-secondary)] border border-[var(--color-border)] p-6 shadow-sm">
                                        ...
                                        <button
                                            onClick={() => alert('Initiating secure encrypted financial routing...')}
                            ...
                            >
                                ...
                                <button
                                    onClick={() => alert('Redirecting to the central high jewelry archive...')}
               ...
               ========================================================================== */}
                {cart.length > 0 && !isPageLoading && (
                    <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-bg)]/95 backdrop-blur-md border-t border-[var(--color-border)] z-[200] p-4 flex items-center justify-between gap-4 shadow-[0_-4px_16px_rgba(28,59,72,0.08)]">
                        ...
                        <button
                            onClick={() => alert('Initiating mobile secure layout checkout execution...')}
